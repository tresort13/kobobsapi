...
class Envoies_data(models.Model):
    ...
    code_retrait = models.CharField(max_length=9,null=True,unique=True)
    data_operation = models.CharField(max_length=20,default="")
    date_heure_operation =models.CharField(max_length=20,default="")
