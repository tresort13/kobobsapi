...
class Envoies_data(models.Model):
    ...
    montant_envoie_sans_frais = models.DecimalField(max_digits=15, decimal_places=2,default="")
    montant_beneficiaire = models.DecimalField(max_digits=15, decimal_places=2,default="")
    type_service = models.CharField(max_length=100,default="")  
    frais_envoie = models.DecimalField(max_digits=15,decimal_places=2)
    frais_tva = models.DecimalField(max_digits=15,decimal_places=2,default="")  
